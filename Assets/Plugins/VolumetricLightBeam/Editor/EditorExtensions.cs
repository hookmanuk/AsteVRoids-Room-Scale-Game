...
namespace VLB
{
    public static class EditorExtensions
    {
        ...
        static void Menu_AttachBeam(MenuCommand menuCommand)
        {
        ...
        const string kAddParticles = "CONTEXT/VolumetricLightBeam/Add Dust Particles";
        ...
        const string kAddDynamicOcclusionRaycasting = "CONTEXT/VolumetricLightBeam/Add Dynamic Occlusion (Raycasting)";
        ...
        const string kAddDynamicOcclusionDepthBuffer = "CONTEXT/VolumetricLightBeam/Add Dynamic Occlusion (Depth Buffer)";
        ...
        const string kAddTriggerZone = "CONTEXT/VolumetricLightBeam/Add Trigger Zone";
